...
// pixi-graph/node_modules/color-name/index.js
var require_color_name = __commonJS({
  "pixi-graph/node_modules/color-name/index.js"(exports, module) {
    "use strict";
    module.exports = {
...
// pixi-graph/node_modules/color-space/rgb.js
var require_rgb = __commonJS({
  "pixi-graph/node_modules/color-space/rgb.js"(exports, module) {
    "use strict";
    module.exports = {
      name: "rgb",
      min: [0, 0, 0],
...
// pixi-graph/node_modules/color-space/hsl.js
var require_hsl = __commonJS({
  "pixi-graph/node_modules/color-space/hsl.js"(exports, module) {
    "use strict";
    var rgb = require_rgb();
    module.exports = {
      name: "hsl",
      ...
      alias: ["HSL"],
      rgb: function(hsl2) {
        var h = hsl2[0] / 360, s = hsl2[1] / 100, l = hsl2[2] / 100, t1, t2, t3, rgb2, val;
        if (s === 0) {
          val = l * 255;
          return [val, val, val];
        }
...
// pixi-graph/node_modules/color-parse/index.mjs
...
// pixi-graph/node_modules/color-rgba/index.mjs
var import_hsl = __toESM(require_hsl(), 1);
function rgba(color) {
  ...
  if (parsed.space[0] === "h") {
    values = import_hsl.default.rgb(values);
  }
